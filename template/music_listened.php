<article id="page_full">
    <section id="content">
    	<div id="submenu">
    		...
    		<a href="<?php echo $domaine; ?>user/music" title=""><?php echo $music->sokial('U02'); ?></a>
            <a href="<?php echo $domaine; ?>musik/listened" title="" class="active"><?php echo $music->sokial('U10'); ?></a>
