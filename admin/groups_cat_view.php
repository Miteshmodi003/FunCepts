...
function up_cat($id_cat,$name) {
    ...
    $update = $db->prepare("UPDATE groups_cat SET
        name = '".$name."'
        WHERE
        id_cat = :id_cat");
...
if(isset($_POST) && isset($_POST['name'])){
    ...
    if(!empty($_POST['name'])){
        ...
        echo '<meta http-equiv="refresh" content="1;URL=groups_cat.php">';
...
if(isset($_POST) && isset($_POST['delete'])){
    ...
    $db->exec("DELETE FROM groups_cat WHERE id_cat = '".$_POST['delete']."' ");
